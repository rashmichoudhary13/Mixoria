    ...
    return (
        <section className='min-h-dvh mb-30'>
            <div className='text-center my-10'>
                <h2 className='text-3xl lg:text-5xl'> WHY OUR DRINKS? </h2>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 mx-5 md:mx-30 lg:mx-10'>
                ...
                <div className='order-2 lg:order-1 mt-10 lg:mt-35 lg:pl-40 flex flex-col gap-10 h-[50vh] no-scrollbar overflow-y-auto'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='libre-baskerville-min text-sm lg:text-base'>We believe great drinks start with great ingredients. 
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='libre-baskerville-min text-sm lg:text-base'>Our drinks are crafted to strike the perfect balance — never too 
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='libre-baskerville-min text-sm lg:text-base'>What you see is what you taste — nothing more, nothing less. 
                    ...
                    <div className='space-y-3'>
                        <h2 className='text-2xl lg:text-3xl text-yellow-200 flex gap-5'> 
                            ...
                            Crafted Daily </h2>
                        <p className='libre-baskerville-min text-sm lg:text-base'>Freshness isn’t optional — it’s our standard. Our drinks are prepared daily 
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='libre-baskerville-min text-sm lg:text-base'>From laid-back afternoons to celebratory evenings, our drinks are made to fit 
